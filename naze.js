...
module.exports = naze = async (naze, m, chatUpdate, store) => {
    try {
		...
		const fgclink = {key: {participant: "0@s.whatsapp.net","remoteJid": "0@s.whatsapp.net"},"message": {"groupInviteMessage": {"groupJid": "6289519240209-6289519240209@g.us","inviteCode": "m","groupName": "YT Kage", "caption": '©Naze', 'jpegThumbnail': thumb}}}
		...
		const fkontak = { key: {participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: `status@broadcast` } : {}) }, message: { 'contactMessage': { 'displayName': 'Kage Dev', 'vcard': `BEGIN:VCARD\nVERSION:3.0\nN:XL;Kage Dev,;;;\nFN:Kage Dev\nitem1.TEL;waid=6289519240209:6289519240209\nitem1.X-ABLabel:Ponsel\nEND:VCARD`, 'jpegThumbnail': thumb, thumbnail: thumb,sendEphemeral: true}}}
...
//Pembatas========================================
	    ...
	    case 'nomerhoki': case 'nomorhoki': {
                if (!Number(text)) throw `Example : ${prefix + command} 6289519240209`
...
let buttons = [{ buttonId: 'allmenu', buttonText: { displayText: '📖List Menu' }, type: 1 },{ buttonId: 'donasi', buttonText: { displayText: '👑Sewa' }, type: 1 }]
            ...
            case 'sponsor': {
            if (!m.isGroup) throw mess.group
            let qontak = `6289519240209@s.whatsapp.net`
